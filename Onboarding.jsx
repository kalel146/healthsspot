  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`w-full max-w-xl overflow-hidden rounded-[28px] border shadow-2xl ${
      ...
      >
        <div
          className={`px-6 py-5 md:px-8 ${
            isDark
              ? "bg-[radial-gradient(circle_at_top_left,rgba(250,204,21,0.18),transparent_38%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.14),transparent_34%)]"
              : "bg-[radial-gradient(circle_at_top_left,rgba(250,204,21,0.14),transparent_36%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.10),transparent_32%)]"
          }`}
        >
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 className="mt-2 text-2xl font-black md:text-3xl">
                Καλώς ήρθες, {user.firstName || user.username || "Athlete"}
              </h1>
              <p className={`mt-2 text-sm ${isDark ? "text-zinc-300" : "text-zinc-600"}`}>
                Μικρό onboarding, καθαρή είσοδος, τέλος τα περιττά εμπόδια.
              </p>
            </div>

            <div
              className={`rounded-2xl px-4 py-3 text-right ${
                isDark ? "bg-black/35 ring-1 ring-white/10" : "bg-white/70 ring-1 ring-zinc-200"
              }`}
            >
          ...
          <div className={`mt-5 h-2 w-full overflow-hidden rounded-full ${isDark ? "bg-zinc-800" : "bg-zinc-200"}`}>
            <div
              className="h-full rounded-full bg-gradient-to-r from-yellow-500 via-amber-400 to-yellow-300 transition-all duration-300"
        ...
        <div className="px-6 py-6 md:px-8 md:py-8">
              ...
              <div
                ...
                className={`rounded-2xl p-4 text-sm ${
                  item.id === step
                    ...
                    : isDark
                    ? "bg-white/[0.035] text-zinc-400 ring-1 ring-white/6"
          ...
          <div
            className={`mt-6 rounded-2xl px-4 py-3 text-sm ${
              isDark
                ? "bg-white/[0.035] text-zinc-300 ring-1 ring-white/6"
          ...
          <div className="mt-8 flex items-center justify-between gap-3">
            ...
            {step < steps.length ? (
              ...
              <button
                ...
                disabled={loading}
                className="rounded-xl bg-yellow-500 px-5 py-2.5 text-sm font-bold text-black transition hover:bg-yellow-400 disabled:cursor-not-allowed disabled:opacity-60"
              >
